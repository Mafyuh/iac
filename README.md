...
| ------------------------- | --------------------------------------------------------------------------------------------------------------------- | ----------------- | ---------- | -------------------------------------------------------- | --------------- | --------------------- |
| **Talos-4**               | Lenovo P330 Tiny                                                                                                      | Intel i7-9700     | 32GB DDR4  | 2x 512GB NVME                                            | Integrated      | k8s control-plane     |
| **Talos-5**               | Lenovo P330 Tiny                                                                                                      | Intel i7-9700     | 32GB DDR4  | 2x 512GB NVME                                            | Integrated      | k8s control-plane     |
| **Talos-6**               | Lenovo P330 Tiny                                                                                                      | Intel i7-9700     | 32GB DDR4  | 2x 512GB NVME                                            | Integrated      | k8s control-plane     |
